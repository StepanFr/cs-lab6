namespace lab6_1
{
    ...
    public class Program
    {
        ...
        private const int NumberOfRequests = 50; // Количество запросов
        ...
        public static async Task Main(string[] args)
        {
            ...
            while (weatherList.Count < NumberOfRequests)
            {
                ...
                float latitude = (float)(random.NextDouble() * 180 - 90); // от -90 до 90
                float longitude = (float)(random.NextDouble() * 360 - 180); // от -180 до 180
            ...
            // Максимальная и минимальная temperatura
        ...
        private static async Task<Weather?> GetWeatherDataAsync(float latitude, float longitude)
        {
            ...
            {
                Console.WriteLine($"Ошибка получения данных о погоде: {ex.Message}. Пытаемся снова...");
            }

            return null; // Возвращаем null, если данные не были получены
        }
    }
}